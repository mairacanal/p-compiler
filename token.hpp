...
class Token {
 ...
 public:
   ...
   * output stream.
   *
   * This function allows a Token object to be printed to an output stream
   * (std::ostream) in a customized way.
   *
   ...
   * @return A reference to the output stream after the Token object has been
   * inserted.
   */
